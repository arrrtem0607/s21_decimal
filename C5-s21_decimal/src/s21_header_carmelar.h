...
int s21_add_bit(s21_decimal number_1, s21_decimal number_2, s21_decimal* result);
...
void s21_set_scale_ratio_16_23(s21_decimal* number, int scale);  // устанавливает коэфициент масштабирования (scale)
